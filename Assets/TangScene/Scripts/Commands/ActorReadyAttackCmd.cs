...
namespace TangScene
{
  public class ActorReadyAttackCmd : SimpleCommand
  {
    public const string NAME = "TS_INNER_ACTOR_READY_ATTACK";
      ...
      if( bean != null && Cache.actors.ContainsKey( bean.casterId) )
	{
	  ...
	  characterStatusBhvr.Status = CharacterStatus.readyAttack;
