...
public class EasyTouch : MonoBehaviour {
	...
	private bool GetPickeGameObject(ref Finger finger){
		return GetPickeGameObject(ref finger, false);
	}

	private bool GetPickeGameObject(ref Finger finger, bool twoFinger){
	...
	public static void SetCamera(Camera cam,bool guiCam){
	...
	public static bool IsRectUnderTouch( Rect rect){
		return IsRectUnderTouch(rect,false);
	}
