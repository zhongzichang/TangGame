...
public class HTGUILayout{
	...
	public static bool FoldOut( ref bool foldOut,string text){
		return FoldOut( ref foldOut,text, false);
	}
	public static bool FoldOut( ref bool foldOut,string text, bool addButton){
		return FoldOut( ref foldOut,text, addButton,"+");
	}
	// FoldOut
	public static bool FoldOut( ref bool foldOut,string text, bool addButton, string buttonText){
	...
	static public bool Button(string label,Color color,int width){
		return Button(label, color,width, true, 0);
	}
	static public bool Button(string label,Color color,int width, bool leftAligment){
		return Button(label, color, width, leftAligment,0);
	}
	// Button
	static public bool Button(string label,Color color,int width, bool leftAligment, int height){
	...
	public static void DrawSeparatorLine(int padding)
	{
		DrawSeparatorLine(Color.gray, padding);
	}
	public static void DrawSeparatorLine(Color color){
		DrawSeparatorLine(color, 0);
	}
	public static void DrawSeparatorLine(Color color,int padding)
	{
