...
public class HTEditorToolKit
{
	...
	public static bool DrawTitleChildFoldOut (bool foldOut, string text){
		return DrawTitleChildFoldOut(foldOut, text ,0);
	}
	public static bool DrawTitleChildFoldOut (bool foldOut, string text, int padding)
	{
	...
	private static Rect DrawTitleChildGradient(){
		return DrawTitleChildGradient(0);
	}
	private static Rect DrawTitleChildGradient (int padding)
	{
		GUILayout.Space (30);
		Rect lastRect = GUILayoutUtility.GetLastRect ();
		lastRect.yMin = lastRect.yMin + 5;
